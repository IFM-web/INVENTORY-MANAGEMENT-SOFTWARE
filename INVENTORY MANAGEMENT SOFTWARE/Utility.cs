...
namespace INVENTORY_MANAGEMENT_SOFTWARE

{
	public class Utility
	{
        ...
        //connectionString="Data Source=172.16.3.2;Initial Catalog=InventoryManagementSolution;User ID=sa;Password=sqlserver@2018!@#;
		//connectionString="Data Source=172.16.3.2;Initial Catalog=InventoryManagementSolution";
        SqlConnection sqcon = new SqlConnection(@"Data Source=172.16.3.2;Initial Catalog=InventoryManagementSolution ;User ID=sa;Password=sqlserver@2018!@#");
		public string cs = @"Data Source=172.16.3.2;Initial Catalog=InventoryManagementSolution;User ID=sa;Password=sqlserver@2018!@#";
		//SqlConnection sqcon = new SqlConnection(@"Data Source=180.179.213.214,1533;Initial Catalog=DC_NEW;user id=DC_NEW;password=Hauz%6476");
		//public string cs = @"Data Source=180.179.213.214,1533;Initial Catalog=DC_NEW;user id=DC_NEW;password=Hauz%6476";
		SqlCommand sqcmd;
